...
Choissis 1 porte, ${chalk.bgRed('MAIS ATTENTION')} !!!! choissis la bonne ;)`)
...
console.log(`Très bien tu as choisi la ${chalk.yellow(tab[0][playerChoice])}. Maintenant laisse moi te dire que dans la ${chalk.red(tab[0][revealedDoor(tab, playerChoice)])} il y avait une ${chalk.red(tab[1][revealedDoor(tab, playerChoice)])}`)
